...
<body class="bg-body-secondary">
    ...
    <header class="container-fluid p-0 overflow-hidden">
        <div class="card text-bg-dark overflow-hidden">
            <img src="https://images.unsplash.com/photo-1724436281331-68ae2a523d22?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                class="card-img header-img" alt="..." style="height: 250px">
    ...
    <section class="row justify-content-center my-5">
        <div class="col-6 shadow-xl bg-white text-center p-5">
            <h1 class="text-center">OOOOOPS! "Qualcosa è andato storto!"</h1>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12">
                <img src="/storage/asset/404.png" alt="Error 404 png" class="img-fluid">
            </div>
        </div>
    </div>
        </div>
